...
@section('content')
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h3 class="card-title">افزودن موضوع</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('KnowledgeBase.store') }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
    ...
    @push('scripts')
        ...
        <script>
            // $(function() {
            //     $(".attachments").on('change', 'input:file',function (){
            //         $(".attachments").append('<div class="col-md-12">' +
            //             '<label class="custom-file-upload">' +
            //             '<input type="file" name="attachments[]"/>' +
            //             '<span class="file_name"><i class="fa fa-upload"></i> انتخاب فایل</span>' +
            //             '</label>' +
            //         '</div>');
            //
            //         var fileName = $(this).val().replace(/C:\\fakepath\\/i, '');
            //         $(this).next('.file_name').text(fileName);
            //         $(this).parent('col-md-12').append('<a class="remove-file"><i class="fa fa-trash"></i> </a>');
            //     });
            // });
        </script>
    @endpush
